...
public class DefaultMsgProducer implements MsgProducer {
    ...
    public void init(){
        if(this.checkSend()){
            ...
            System.out.println(" The sendEnable is advised being true. If not true, any producer Will not be created!!!");
        }
    }
    ...
    public boolean send(String topic, Object key, Object partKey, Object msg) {
        ...
        if(this.checkSend()){
            try {
                System.out.println("PRODUCER TOPIC: " + topic + ",MSG: " + msg.toString());
